...
<body>
    ...
    <section class="home d-flex justify-content-center">
        <div class="row">
            <div class="col-md-12">
                <h1 class="display-4">Venha para a casa da Dona Rita, e Escolha a sua marmita!</h1>
                <p class="display-1 text-center">Impossível não voltar novamente</p>

                <div class="d-flex justify-content-center">
                    <a class="btn btn-outline-dark" href="assets/marmitas.php">Encontrar Marmitas</a>
                </div>
            </div>
        </div>
    </section>
